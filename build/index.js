...
function Edit(_ref) {
  ...
  function onChangetitleAlignment(newtitleAlignment) {
    setAttributes({
      titleAlignment: newtitleAlignment === undefined ? "none" : newtitleAlignment
    });
  }
  function onChangebodyAlignment(newbodyAlignment) {
    setAttributes({
      bodyAlignment: newbodyAlignment === undefined ? "none" : newbodyAlignment
    });
  }
