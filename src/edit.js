...
export default function Edit({ attributes, setAttributes }) {
	...
	function onChangetitleAlignment(newtitleAlignment) {
		setAttributes({
			titleAlignment:
				newtitleAlignment === undefined ? "none" : newtitleAlignment,
		});
	}
	function onChangebodyAlignment(newbodyAlignment) {
		setAttributes({
			bodyAlignment:
				newbodyAlignment === undefined ? "none" : newbodyAlignment,
		});
	}
	...
	return [
		<InspectorControls style={{ marginBottom: "40px" }}>
			...
			<PanelBody title={"Body-Alignment"}>
				<AlignmentToolbar
		...
		<div {...useBlockProps()}>
			...
			>
				...
				{/* {
					<BlockControls>
						<titleAlignmentToolbar onChange={onChangetitleAlignment} value={titleAlignment} />
					</BlockControls>
				} */}
				...
				<RichText
					...
					style={{ textAlign: bodyAlignment, fontSize: selectSize }}
					value={body}
